#
# = CSS RDoc HTML template
#
# This is an HTML template that dictates a bit more of the appearance of the
# output HTML to cascading stylesheets than the default. It is designed for
# inline code, and will toggle the display of each method's source with a click
# on the method name.
#
# An example may be found at <http://mues.FaerieMUD.org/rdoc/>.
#
# == CVSID
#
#   $Id: css2.rb,v 1.1 2002/07/07 18:16:43 deveiant Exp $
#
# == Authors
#
