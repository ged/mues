...
EXTRA_PKGFILES = []
EXTRA_PKGFILES.concat Pathname.glob( "#{BASEDIR}/server/**/*" ).delete_if {|item| item.to_s =~ /\.svn/ } 
...
RDOC_OPTIONS = [
	...
	'-m', 'README',
	'-t', PKG_NAME,
	'-W', 'http://deveiate.org/projects/MUES/browser/trunk/'
  ]
