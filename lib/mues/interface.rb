#!/usr/bin/ruby
# 
# This file contains the MUES::Metaclass::Interface metaclass, which is used to
# add interfaces to instances of MUES::Metaclass::Class. Interfaces in this
# system are a bit different than those in the UML -- they can be used to
# actually add default functionality to a class which implements it, instead of
# simply expressing requirements.
# 
# == Synopsis
# 
	...
	module Metaclass
		...
		class Interface
			...
			def initialize( name, superclass=nil )
				checkType( superclass, NilClass, Metaclass::Interface )
			...
			module Methods
				...
				def addInterface( interface )
					checkType( interface, Metaclass::Interface )
				...
				def removeInterface( interface )
					checkType( interface, Metaclass::Interface, ::String )
