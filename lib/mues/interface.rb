...
# == Rcsid
# 
# $Id: interface.rb,v 1.4 2002/06/04 06:54:02 deveiant Exp $
# 
# == Authors
# 
...
module Metaclass
	...
	class Interface
		...
		Rcsid = %q$Id: interface.rb,v 1.4 2002/06/04 06:54:02 deveiant Exp $
		...
		### method defined by the Metaclass::Operation::Functions, as we need to
		### do some special trickery with Module#append_features to add methods
		...
		def classOperationsDeclaration( includeComments = true )
			...
			unless @classOperations.empty?
				...
				decl << "def append_features( klass )" <<
					"    $stderr.puts('In manufactured append_features...')" <<
					"    super( klass )" <<
					"    klass.module_eval {"
